...
-   [Figure 4 A & B - ChIP-Seq single gene coverage plots](#figure-4-a-b---chip-seq-single-gene-coverage-plots)
...
![](MDCK_EMT_Analysis_files/figure-markdown_github-ascii_identifiers/Figure_2_A-1.png)
...
![](MDCK_EMT_Analysis_files/figure-markdown_github-ascii_identifiers/Figure_2_B_C-1.png)
...
```
    ...
    ## Warning in if (is.null(x)) return(as.data.frame(list())): closing unused
    ...
    ## Warning in if (is.null(x)) return(as.data.frame(list())):
...
wtPlotDown <- ggplot(plotDataWT[grep("down", plotDataWT$geneset), 
...
diffPlotDown <- ggplot(diffData[grep("down", diffData$geneset), 
    ...
    linetype = "twodash") + coord_cartesian(ylim = c(diffylimMax, 
    diffylimMin)) + scale_x_continuous(breaks = c(0, 50, 100, 
...
![](MDCK_EMT_Analysis_files/figure-markdown_github-ascii_identifiers/Figure_3_plotting_1-1.png)
...
![](MDCK_EMT_Analysis_files/figure-markdown_github-ascii_identifiers/Figure_3_CDE_plotting-1.png)
...
![](MDCK_EMT_Analysis_files/figure-markdown_github-ascii_identifiers/Figure_4_panels_AB-1.png)
...
![](MDCK_EMT_Analysis_files/figure-markdown_github-ascii_identifiers/Figure_4_panels_AB-2.png)
